...
## AutoPrune policy wrapper

For the canonical 32-token policy, run a benchmark command through:
...
The benchmark-specific data preparation below follows the inherited LLaVA/CDPruner evaluation protocol.
